...
- [ ] Napraviti mali tehnički eksperiment sa Google Code Scanner API-jem iz ML Kit ponude. (S2 implementacija i lokalne provere su završene; fizička validacija S3 još predstoji.)
