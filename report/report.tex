...
\IfFileExists{report/assets/asap-architecture.png}{%
  \newcommand{\reportassetpath}{report/assets/}%
}{%
  \newcommand{\reportassetpath}{assets/}%
}
\hypersetup{
...
\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{\reportassetpath asap-architecture.png}
\caption{Početni koncept komponenti sistema; biće preciziran tokom faze projektovanja.}
\end{figure}
