...
Za Android klijent izabrani su Java i XML zasnovani Android Views. Početni projekat je implementiran kao jedan \texttt{app} modul unutar direktorijuma \texttt{android}. Njegov paket je \texttt{rs.ac.ni.elfak.asap}, a sadrži jednu aktivnost i prilagođeni XML ekran sa akcijom skeniranja, statusom i očitanom vrednošću. Koristi Java 17, AGP 9.3.2, Gradle Wrapper 9.5.0, \texttt{compileSdk}/\texttt{targetSdk 36}, \texttt{minSdk 23}, Build Tools 36.0.0, AppCompat 1.8.0 i ConstraintLayout 2.2.2. Build, sedam lokalnih testova i Android lint prolaze, a APK još nije instaliran na uređaj.

\subsection{AI tehnologije}

Za početno očitavanje barkoda implementiran je Google Code Scanner 16.1.0, koji skeniranje delegira Google Play servisima bez dozvole aplikacije za kameru. Skener koristi automatsko uvećanje i ograničen je na EAN-13, EAN-8, UPC-A i UPC-E formate. Manifest sadrži \texttt{barcode\_ui} metapodatak za isporuku modula, a ekran razlikuje uspeh, otkazivanje, nedostupnost ili problem preuzimanja modula i opštu grešku. Fizička provera stvarnog barkoda i isporuke modula još nije sprovedena. Direktni ML Kit Barcode Scanning i CameraX su odloženi. Model za embedding reprezentacije, vektorski indeks i metrike evaluacije još nisu izabrani.
