...
Za Android klijent izabrani su Java i XML zasnovani Android Views. Početni projekat je implementiran kao jedan \texttt{app} modul unutar direktorijuma \texttt{android}. Njegov paket je \texttt{rs.ac.ni.elfak.asap}, a sadrži jednu aktivnost i XML ekran. Koristi Java 17, AGP 9.3.2, Gradle Wrapper 9.5.0, \texttt{compileSdk}/\texttt{targetSdk 36}, \texttt{minSdk 23}, Build Tools 36.0.0, AppCompat 1.8.0 i ConstraintLayout 2.2.2. Build, lokalni test i Android lint prolaze, a APK još nije instaliran na uređaj.

\subsection{AI tehnologije}

Za početno očitavanje barkoda izabran je Google Code Scanner 16.1.0, koji skeniranje delegira Google Play servisima bez dozvole aplikacije za kameru. Zavisnost i modul skenera još nisu dodati početnom shell-u; njihova implementacija i obrada prvog preuzimanja pripadaju sledećoj fazi eksperimenta. Direktni ML Kit Barcode Scanning i CameraX su odloženi. Model za embedding reprezentacije, vektorski indeks i metrike evaluacije još nisu izabrani.
